...
game_user= Table(
    ...
    Column('user_id', ForeignKey('user_id'), primary_key= True),
    extend_existing=True
    #To Game class add: users = relationship('User', secondary=game_user, back_populates='games')
    #To User class add: games = relationship('Game', secondary=game_user, back_populates='users')
)
...
#Relationship association object for the rlship between games and users
# class GameUser(Base):
